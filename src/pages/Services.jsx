...
const Services = () => {
  return (
    <div className="mb-28 mt-[70px] flex flex-wrap justify-center gap-14 lg:flex-nowrap">
      ...
      <div className="flex flex-col items-center justify-center lg:w-1/2 lg:items-start gap-4">
        {SERVICES.map(({ id, title, content, img }) => {
          return (
            <div
              key={id}
              className="transform items-center border-b-2 p-5 last:border-b-0 md:flex"
            >
              {/* Icon */}
              <img
